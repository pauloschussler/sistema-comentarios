...
<div class="py-5">
  <div class="container">
    <div class="row py-5" style="">
      <div class="col-md-5 order-2 order-md-1"> <img class="img-fluid d-block my-3 mx-auto animate-in-left" src="<?php echo e(asset('assets/imagens/iphone.jpg')); ?>" width="200"> </div>
    ...
    <div class="row border-bottom">
      ...
      <div class="col-8 mx-auto">
        <div class="row py-2">
        <div class="col-9">
            <form method="POST" action="<?php echo e(route('comentario')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-10 mx-auto">
          <?php foreach($comentarios as $comentario){?>
            <div class="row py-3">
                <div class="col-md-2"><img class="img-fluid d-block rounded-circle" src="<?php echo e(URL::asset('assets/imagens/usuarios/padrao.jpg')); ?>"></div>
                <div class="col-md-10">
                  <div class="card">
...
<?php /**PATH C:\xampp\htdocs\sistema-comentarios\resources\views/Inicio_View.blade.php ENDPATH**/ ?>